...
private:
    ...
    //     if constexpr (n == 1){
    //         return lowerMatrix[0][0];
    //     } else if constexpr (n == 2){
    //         return lowerMatrix[0][0] * lowerMatrix[1][1] - lowerMatrix[0][1] * lowerMatrix[1][0];
    //     } else {
    //         T det = 0;
    ...
    //                 for (int j = 0; j < n; j++){
    //                     if (j != colMin){
    //                         sub[i-1][subCol] = lowerMatrix[i][j];
    //                         subCol++;
    //                     }
    //                 }
    //             }
    //             int sign = (colMin % 2 == 0) ? 1 : -1;
    //             det += sign * lowerMatrix[0][colMin] * minorCalculator<n-1>(sub);
    //         }
    //         return det;
    //     }
    // }
